...
export ITEM_BG_COLOR_TREE=0xffc3e88d
export ITEM_BG_COLOR_FOUR=0xffffc777
export ITEM_BG_COLOR_FIVE=0xffc0caf5
export ITEM_BG_COLOR_SIX=0xffbb9af7
export ITEM_BG_COLOR_SEVEN=0xff41a6b5

# export ITEM_BG_COLOR_ONE=0xffc0caf5
# export ITEM_BG_COLOR_TWO=0xffc0caf5
# export ITEM_BG_COLOR_TREE=0xffc0caf5
# export ITEM_BG_COLOR_FOUR=0xffc0caf5
# export ITEM_BG_COLOR_FIVE=0xffc0caf5
